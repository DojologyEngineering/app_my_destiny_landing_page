<template>
  <footer class="w-full bg-primary-light">
    <div class="max-w-[1024px] mx-auto px-5 md:px-10 pt-8">
      <div
      ...
      >
        ...
        <div class="hidden justify-center md:justify-start md:flex">
          <NuxtImg
            ...
            width="259"
            height="227"
            class="object-contain w-full h-auto max-w-[259px] md:max-w-[259px] hidden lg:block"
            :placeholder="[50, 25]"
          />
        </div>
        <div class="flex flex-row lg:mt-0 mt-5 align-top space-x-4">
          <NuxtImg
            ...
            width="259"
            height="227"
            class="object-contain w-full h-auto max-w-[218px] pl-4 lg:hidden"
            :placeholder="[50, 25]"
          />
          <div
